...
export const AGENTS_AND_ADMINS = [
  {
    id: "AG-1001",
    name: "Aisha Khan",
    role: "sales",
...
export const AGENTS = AGENTS_AND_ADMINS.filter(
  (agent) => agent.role === "sales"
);
...
export const QUARTERLY_RANKING = [
...
export const MANAGEMENT_TOTAL_DEALS = [
  {
    month: "January",
    dealsWon: 0,
    propertyPrice: 0,
...
export const MANAGEMENT_PROPERTY_TYPES = [
  { name: "Emaar", value: 45.17 },
  { name: "Nakheel", value: 32.41 },
];

export const MANAGEMENT_DEVELOPERS = [
...
export const MANAGEMENT_LEAD_SOURCE = [
...
export const MGMT_CHART_COLORS = ["#003366", "#3b82f6", "#60a5fa"];
